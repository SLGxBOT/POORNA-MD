...
global.email = 'poornabro55@gmail.com' ;
global.location = 'Srilanaka Negombo' ;
global.timezone  = process.env.TIME_ZONE || 'Asia/Negombo'
global.gurl =  process.env.GURL || 'https://youtube.com/c/SLGLEADER' ; // add your username
...
global.github  = process.env.YOUR_GITHUB || 'https://github.com/SLGxBOT/Poorna-Md';
global.scan  = process.env.QR_URL || 'https://replit.com/@SLGxBOT/Poorna-Md?v=1';
global.website = 'https://github.com/SLGxBOT/Poorna-Md' ; //wa.me/+923000000000
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/d5b1c3544fedc23e11a06.jpg' ;

module.exports = {
  sessionName: process.env.SESSION_ID || "",
  botname: process.env.BOT_NAME || 'POORNA-MD',
  ...
  caption: process.env.CAPTION || "```ᴘᴏᴡᴇʀᴇᴅ ʙʏ POORNA²²¹-ᴍᴅ```",   //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
  ...
  // antiCallMessage: process.env.ANTICALL_MESSAGE ||  "\`\`\`Hii this is Poorna-Md a Personal Assistant!!\n\n\tSorry for now, we cannot receive calls, whether in a group or personal \n\n if you need help or request features please chat owner\n\n\nPowered by Suhail-Md Chatbot\`\`\`" ,
  VERSION: process.env.VERSION || 'v.1.2.3',
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : 'SUHAIL',
  menu: process.env.MENU || '', /**  Available @MENU @Schemes 1: Aztec_Md, 2: A17_Md, 3: Poorna-Md Default ---------- If Not Choose then it Randomely Pic One Of Them Each time **/
